          ...
          <ul class="sidebar-menu">
            ...
            <li class="treeview">
              ...
              <ul class="treeview-menu">
                <li><a href="{{url('almacen/view_Categorias_pro')}}"><i class="fa fa-circle-o"></i> Categorías</a></li>
              </ul>
            </li>
            ...
            <li class="treeview">
                <a href="#">
                   <i class="fa fa-user"></i> <span>Administrador</span>
                        ...
                        <ul class="treeview-menu">
                            <li><a href="{{url('Administrador/View_Usuarios')}}"><i class="fa fa-circle-o"></i> Usuarios</a></li>
                            <li><a href="{{url('Administrador/View_Telefonos_usuarios')}}"><i class="fa fa-circle-o"></i> Telefonos Usuarios</a></li>
                            <li><a href=""><i class="fa fa-circle-o"></i> Direccion Usarios</a></li>
                            <li><a href="{{url('Administrador/View_Proveedores')}}"><i class="fa fa-circle-o"></i> Proveedores</a></li>
